<%-- 
    Document   : done_orders
    Created on : Jan 9, 2019, 10:45:56 PM
    Author     : Matrix
--%>
    ...
    <body>
        ...
        <div id="page-inner">
            <div class="row" dir="rtl">
                <h1 class="page-head-line">معلومات الطلبات المنجزة </h1>
	...
	<table cellspacing="0" cellpadding="4" align="Center" id="ContentPlaceHolderContent_GridView1" style="color:#333333;width:80%;border-collapse:collapse;">
		<tr align="center" style="color:White;background-color:#5D7B9D;font-weight:bold;">
			<th scope="col">رقم الطلب</th>
                ...
                List<Order> orders=OrderRepository.getDoneOrdersByCenter(center.center_id);
			...
			<td><%=order.order_id %></td>
                        ...
                        <td><%=order.sState %></td>
                        <td><a href="finish_order.jsp?id=<%= order.order_id  %>" style="color:#333333;">إنهاء</a></td>
		</tr>
                    <%
                }
                }
