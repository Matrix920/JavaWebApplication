...
<html>
       ...
       <div id="page-wrapper">
            <div id="page-inner">
                <div class="row"dir="rtl">
                    <h1 class="page-head-line">معلومات مراكز التوزيع</h1>
	...
	<table cellspacing="0" cellpadding="4" align="Center" id="ContentPlaceHolderContent_GridView1" style="color:#333333;width:90%;border-collapse:collapse;">
			...
			<th scope="col">رقم المركز</th><th scope="col">اسم المركز</th><th scope="col">عنوان المركز</th><th scope="col">رقم الهاتف 1</th><th scope="col">رقم الهاتف 2</th><th scope="col">اسم المشغل المسؤول</th><th scope="col">&nbsp;</th><th scope="col">&nbsp;</th>
            </tr>
            <%
        ...
        for(Center center:centers){
            ...
            <tr style="color:#333333;background-color:#F7F6F3;">
                ...
                <td><%= center.phone1 %>
                </td><td><%= center.phone2 %></td>
                <td><%= center.full_name %></td>
                <td><a href="center_details.jsp?id=<%= center.center_id %>" style="color:#333333;">تعديل</a></td>
                <td><a href="delete_center.jsp?id=<%= center.center_id %>" style="color:#333333;">حذف</a></td>
		</tr>
            <%
        }
            %>	
