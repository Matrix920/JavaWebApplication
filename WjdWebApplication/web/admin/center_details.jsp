...
<html>
    ...
    <%
        ...
        */
        ...
        String center_id=request.getParameter("id");
        ...
        if(user_id!=null && center_name!=null && phone1!=null && phone2!=null && address!=null && center_id!=null){
            Center center=new Center(Integer.parseInt(center_id), Integer.parseInt(user_id), center_name, address, Integer.parseInt(phone1), Integer.parseInt(phone2));
    ...
    <div id="page-wrapper">
            <div id="page-inner">
                <div class="row" dir="rtl">
                    <h1 class="page-head-line">معلومات مركز التوزيع
                    </h1>
                    <div class="pages-style">
                        <% Center center=CenterRepository.getCenter(Integer.parseInt(center_id));%>
                    <table style="width: 100%;" dir="rtl">
                            ...
                            <td>
                                <select name="user_id" id="ContentPlaceHolderContent_DropDownListOperator">
                                    ...
                                    for(User operator:operators){
                                        if(operator.user_id==center.user_id){
                                        %>
                                        <option selected="selected"  value="<%=operator.user_id%>"><%=operator.full_name%></option>
                                        <%
                                        }else{
                                            %>
                        ...
                        <tr>
                            <td>اسم المركز</td>
                            <td>
                                <input name="center_name" type="text" value="<%=center.center_name%>" id="ContentPlaceHolderContent_TextBoxName" /></td>
                            <td>
                        ...
                        <tr>
                            <td>رقم الهاتف 1</td>
                            <td>
                                <input name="phone1" type="text" value="<%=center.phone1%>" id="ContentPlaceHolderContent_TextBoxPhone1" /></td>
                            <td>
                                <span id="ContentPlaceHolderContent_RequiredFieldValidator4" style="visibility:hidden;">(فارغ)</span>
                                <span id="ContentPlaceHolderContent_CompareValidator2" style="visibility:hidden;">(رقم غير صالح)</span>
                        ...
                        <tr>
                            <td>رقم الهاتف 2</td>
                            <td>
                                <input name="phone2" type="text" value="<%=center.phone2%>" id="ContentPlaceHolderContent_TextBoxPhone2" /></td>
                            <td>
                         ...
                         <tr>
                            <td>عنوان المركز</td>
                            <td>
                                <input name="center_address" type="text" value="<%=center.center_address%>" id="ContentPlaceHolderContent_TextBoxAdress" /></td>
                            <td>
