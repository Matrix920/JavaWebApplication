...
<html>
    <head>
        ...
        <title>الشركة العامة للمحروقات</title>
    ...
    <%
        ...
        */
        ...
        if(o!=null){
            ...
            }else if(login.isOperator()){
                response.sendRedirect("operator/index.jsp");
            }else{
        ...
        do login
        */
        String idNumber=request.getParameter(User.NAITONALITY_NUMBER);
        String nationNumber=request.getParameter(User.IDENTITY_NUMBER);

        if(idNumber!=null && nationNumber!=null){
            Login login=UserRepository.doLogin(Long.parseLong(idNumber), Long.parseLong(nationNumber));
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li>
                        <div class="user-name">
                             <div id="loginPanel" class="dark-panel-center">
          <ul style="list-style:none">
            <li>
              <h1>تسجيل الدخول</h1>
            </li>
            <li class="username">
                <input name="identity_number" type="text" id="TextBoxNationNumber" class="login-input" placeholder="الرقم الوطني" />
                </li>
            <li class="password">
                <input name="nationality_number" type="text" id="TextBoxIdentNumber" class="login-input" placeholder="رقم الهوية" />
           </li>
            <li class="button">
                <input type="submit"  value="تسجيل الدخول"   /></li>
          </ul>
        </div>
                    ...
                    <li>
                        <a class="active-menu" href="Default.aspx"><i class="fa fa-dashboard "></i>الرئيسية</a>
                    </li>
                </ul>
